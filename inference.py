...
# Configuration
# -------------------------------
MODEL_PATH = "/Users/Dell/Desktop/repository/updated_ecg_multilabel_model_tf.h5"  
openai.api_key = "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"
...
if uploaded_file:
    ...
    if st.button("Run Diagnosis"):
        ...
        # Display results
        if codes:
            st.success(f"**Diagnosis Results:** {', '.join(codes)}")
